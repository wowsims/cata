...
func (rot *APLRotation) newValueCurrentTime(config *proto.APLValueCurrentTime, uuid *proto.UUID) APLValue {
...
func (rot *APLRotation) newValueCurrentTimePercent(config *proto.APLValueCurrentTimePercent, uuid *proto.UUID) APLValue {
...
func (rot *APLRotation) newValueRemainingTime(config *proto.APLValueRemainingTime, uuid *proto.UUID) APLValue {
...
func (rot *APLRotation) newValueRemainingTimePercent(config *proto.APLValueRemainingTimePercent, uuid *proto.UUID) APLValue {
...
func (rot *APLRotation) newValueNumberTargets(config *proto.APLValueNumberTargets, uuid *proto.UUID) APLValue {
...
func (rot *APLRotation) newValueIsExecutePhase(config *proto.APLValueIsExecutePhase, uuid *proto.UUID) APLValue {

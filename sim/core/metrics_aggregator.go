...
type SpellMetrics struct {
	...
	TotalGlanceDamage    float64 // Damage done by all critical casts of this spell.
	TotalBlockDamage     float64 // Damage done by all critical casts of this spell.
	TotalCritBlockDamage float64 // Damage done by all critical casts of this spell.

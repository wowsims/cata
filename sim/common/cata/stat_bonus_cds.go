...
func init() {
	...
	// HASTE
	shared.NewSimpleStatActive(67152) // Lady La-La's Singing Shell
	...
	core.NewSimpleStatOffensiveTrinketEffect(70142, stats.Stats{stats.MasteryRating: 1700}, time.Second*20, time.Minute*2) // Moonwell Chalice

...
func RegisterAllOnUseCds() {
	...
	shared.NewSimpleStatActive(93262) // Vaporshield Medallion
	shared.NewSimpleStatActive(93341) // Dominator's Deadeye Badge
	shared.NewSimpleStatActive(93344) // Dominator's Knightly Badge
	shared.NewSimpleStatActive(93345) // Dominator's Durable Badge
	...
	shared.NewSimpleStatActive(93260) // Heartwarmer Medallion

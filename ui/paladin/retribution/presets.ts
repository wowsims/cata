	...
	Stats.fromMap(
		{
			...
			[Stat.StatSpellHit]: 0.20,
			[Stat.StatSpellCrit]: 0.06,
			[Stat.StatSpellHaste]: 0.40,
			[Stat.StatMeleeHit]: 2.05,
			[Stat.StatMeleeCrit]: 1.05,
			[Stat.StatMeleeHaste]: 0.59,
			[Stat.StatExpertise]: 1.89,
			[Stat.StatMastery]: 1.34,
		},
		{
			[PseudoStat.PseudoStatMainHandDps]: 8.35,
		},
	),
);

	...
	Stats.fromMap(
		{
			...
			[Stat.StatExpertise]: 1.51,
			[Stat.StatMeleeHit]: 2.36,
			[Stat.StatMeleeCrit]: 1.46,
			[Stat.StatMeleeHaste]: 1.06,
			[Stat.StatMastery]: 0.93,
		},
		{
			[PseudoStat.PseudoStatMainHandDps]: 3.17,
			[PseudoStat.PseudoStatOffHandDps]: 1.64,
		},
	),
	...
	Stats.fromMap(
		{
			...
			[Stat.StatAttackPower]: 1,
			[Stat.StatExpertise]: 1.66,
			[Stat.StatMeleeHit]: 2.62,
			[Stat.StatMeleeCrit]: 1.58,
			[Stat.StatMeleeHaste]: 1.17,
			[Stat.StatMastery]: 1.31,
		},
		{
			[PseudoStat.PseudoStatMainHandDps]: 3.81,

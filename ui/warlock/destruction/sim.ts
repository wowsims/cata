...
const SPEC_CONFIG = registerSpecConfig(Spec.SpecDestructionWarlock, {
	...
	playerIconInputs: [WarlockInputs.PetInput, WarlockInputs.ArmorInput, WarlockInputs.WeaponImbueInput],
	...
	autoRotation: (player: Player<Spec.SpecDestructionWarlock>): APLRotation => {

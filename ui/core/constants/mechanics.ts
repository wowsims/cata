...
// Mastery Ratings have various base %'s and increments based on spec.
export const MASTERY_ROGUE_ASSASSINATION_BASE = 28.0;
export const MASTERY_ROGUE_ASSASSINATION_PER_POINT = 3.5

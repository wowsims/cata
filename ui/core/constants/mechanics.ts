...
export const EXPERTISE_PER_QUARTER_PERCENT_REDUCTION = 102.44574;
export const HASTE_RATING_PER_HASTE_PERCENT = 128.05716;
export const CRIT_RATING_PER_CRIT_PERCENT = 179.28004;
export const PHYSICAL_HIT_RATING_PER_HIT_PERCENT = 102.44574;
export const SPELL_HIT_RATING_PER_HIT_PERCENT = 102.44574;
export const DODGE_RATING_PER_DODGE_PERCENT = 265.07834;
export const PARRY_RATING_PER_PARRY_PERCENT = 265.07834;
export const MASTERY_RATING_PER_MASTERY_POINT = 179.28004;

...
export const EXPERTISE_PER_QUARTER_PERCENT_REDUCTION = 102.445740;
export const HASTE_RATING_PER_HASTE_PERCENT = 128.057160;
export const CRIT_RATING_PER_CRIT_PERCENT = 179.280040;
export const PHYSICAL_HIT_RATING_PER_HIT_PERCENT = 102.445740;
export const SPELL_HIT_RATING_PER_HIT_PERCENT = 102.445740;
export const DODGE_RATING_PER_DODGE_PERCENT = 265.078340;
export const PARRY_RATING_PER_PARRY_PERCENT = 265.078340;

...
export const druidGlyphsConfig: GlyphsConfig = {
	majorGlyphs: {
		[DruidMajorGlyph.GlyphOfFrenziedRegeneration]: {
			...
			description: "For $124769d after activating Frenzied Regeneration, healing effects on you are $54810s1% more powerful.  However, your Frenzied Regeneration now always costs ${$m3/10} Rage and no longer converts Rage into health.",
		...
		[DruidMajorGlyph.GlyphOfProwl]: {
			name: "Glyph of Prowl",
			description: "Reduces the movement penalty of Prowl by ${$m1*100/30}%.",
		...
		[DruidMajorGlyph.GlyphOfInnervate]: {
			...
			description: "When Innervate is cast on a target other than the caster, both the caster and target will benefit, but at $s1% reduced effect.",
		...
		[DruidMajorGlyph.GlyphOfRegrowth]: {
			...
			description: "Increases the critical strike chance of your Regrowth by $m1%, but removes the periodic component of the spell.",
		...
		[DruidMajorGlyph.GlyphOfRejuvenation]: {
			...
			description: "When you have Rejuvenation active on three or more targets, the cast time of your Nourish spell is reduced by $s2%.",
		...
		[DruidMajorGlyph.GlyphOfEfflorescence]: {
			...
			description: "The Efflorescence effect is now caused by your Wild Mushroom instead of by Swiftmend, and lasts as long as the Wild Mushroom is active.  Additionally, increases  the healing done by Swiftmend by $s1%.",
			iconUrl: "https://wow.zamimg.com/images/wow/icons/large/spell_nature_healingtouch.jpg",
		},
		...
		[DruidMajorGlyph.GlyphOfHurricane]: {
			...
			description: "Your Hurricane and Astral Storm abilities now also slow the movement speed of their victims by $s1%.",
		...
		[DruidMajorGlyph.GlyphOfSkullBash]: {
			...
			description: "Increases the duration of your Skull Bash interrupt by ${$m2/1000} sec, but increases the cooldown by ${$m1/1000} sec.",
		...
		[DruidMajorGlyph.GlyphOfSavagery]: {
			...
			description: "Savage Roar can now be used with 0 combo points, resulting in a $127538d duration.",
		...
		[DruidMajorGlyph.GlyphOfBlooming]: {
			...
			description: "Increases the bloom heal of your Lifebloom when it expires by $s1%, but its duration is reduced by ${$m2/-1000} sec and your Healing Touch, Nourish, and Regrowth abilities no longer refresh the duration.",
			iconUrl: "https://wow.zamimg.com/images/wow/icons/large/spell_nature_protectionformnature.jpg",
		},
		[DruidMajorGlyph.GlyphOfDash]: {
			name: "Glyph of Dash",
			description: "Reduces the cooldown of your Dash ability by ${$m1/-1000} sec.",
		...
		[DruidMajorGlyph.GlyphOfMasterShapeshifter]: {
			...
			description: "Reduces the mana cost of all shapeshifts by $s1%.",
		...
		[DruidMajorGlyph.GlyphOfSurvivalInstincts]: {
			...
			description: "Reduces the cooldown of Survival Instincts by ${$m1/-1000} sec, but reduces its duration by $s2%.",
		...
		[DruidMajorGlyph.GlyphOfStampedingRoar]: {
			...
			description: "Increases the radius of Stampeding Roar by $s1 yards.",
		...
		[DruidMajorGlyph.GlyphOfCyclone]: {
			...
			description: "Increases the range of your Cyclone spell by $s1 yards.",
		...
		[DruidMajorGlyph.GlyphOfFaeSilence]: {
			...
			description: "Faerie Fire used in Bear Form also silences the target for $114238d, but triggers a 15 sec cooldown.",
		...
		[DruidMajorGlyph.GlyphOfFaerieFire]: {
			...
			description: "Increases the range of your Faerie Fire by $s1 yds.",
		...
		[DruidMajorGlyph.GlyphOfCatForm]: {
			...
			description: "Increases healing done to you by $s1% while in Cat Form.",
	...
	minorGlyphs: {
		...
		[DruidMinorGlyph.ZzoldGlyphOfTheChameleon]: {
			name: "zzOLD Glyph of the Chameleon",
			description: "Each time you shapeshift into Cat Form or Bear Form, your shapeshifted form will have a random hair color.",
			iconUrl: "https://wow.zamimg.com/images/wow/icons/large/ability_druid_mastershapeshifter.jpg",
		},

...
export const paladinGlyphsConfig: GlyphsConfig = {
	primeGlyphs: {
		[PaladinPrimeGlyph.GlyphOfBeaconOfLight]: {
		...
		[PaladinPrimeGlyph.GlyphOfCleansing]: {
		...
		[PaladinPrimeGlyph.GlyphOfConsecration]: {
		...
		[PaladinPrimeGlyph.GlyphOfDazingShield]: {
		...
		[PaladinPrimeGlyph.GlyphOfDivinePlea]: {
		...
		[PaladinPrimeGlyph.GlyphOfDivineProtection]: {
		...
		[PaladinPrimeGlyph.GlyphOfDivinity]: {
		...
		[PaladinPrimeGlyph.GlyphOfHammerOfWrath]: {
		...
		[PaladinPrimeGlyph.GlyphOfHolyWrath]: {
		...
		[PaladinPrimeGlyph.GlyphOfRebuke]: {
		...
		[PaladinPrimeGlyph.GlyphOfReckoning]: {
		...
		[PaladinPrimeGlyph.GlyphOfSalvation]: {
		...
		[PaladinPrimeGlyph.GlyphOfTheAsceticCrusader]: {
		...
		[PaladinPrimeGlyph.GlyphOfTheLongWord]: {
		...
		[PaladinPrimeGlyph.GlyphOfTurnEvil]: {

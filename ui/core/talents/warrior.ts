...
export const warriorGlyphsConfig: GlyphsConfig = {
	primeGlyphs: {
		[WarriorPrimeGlyph.GlyphOfCleaving]: {
		...
		[WarriorPrimeGlyph.GlyphOfColossusSmash]: {
		...
		[WarriorPrimeGlyph.GlyphOfDeathWish]: {
		...
		[WarriorPrimeGlyph.GlyphOfHeroicThrow]: {
		...
		[WarriorPrimeGlyph.GlyphOfIntercept]: {
		...
		[WarriorPrimeGlyph.GlyphOfIntervene]: {
		...
		[WarriorPrimeGlyph.GlyphOfLongCharge]: {
		...
		[WarriorPrimeGlyph.GlyphOfPiercingHowl]: {
		...
		[WarriorPrimeGlyph.GlyphOfShieldWall]: {
		...
		[WarriorPrimeGlyph.GlyphOfShockwave]: {
		...
		[WarriorPrimeGlyph.GlyphOfSpellReflection]: {
		...
		[WarriorPrimeGlyph.GlyphOfSunderArmor]: {
		...
		[WarriorPrimeGlyph.GlyphOfSweepingStrikes]: {

import { EquipmentSpec, GemColor, HandType, ItemSlot, ItemSpec, ItemSwap, Profession, SimGem } from '../proto/common.js';
import { SimDatabase, SimEnchant, SimItem } from '../proto/db';
